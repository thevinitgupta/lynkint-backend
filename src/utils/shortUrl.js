...
var shortUrlGenerator = function (size) {
    if (size === void 0) { size = 7; }
    return __awaiter(void 0, void 0, void 0, function () {
        var shortURL;
        return __generator(this, function (_a) {
            try {
                shortURL = (0, crypto_random_string_1.default)({ length: size, type: 'url-safe' });
                console.log(shortURL);
                return [2 /*return*/, shortURL];
            }
            catch (error) {
                throw new custom_error_model_1.CustomError("Error creating Short URL", 500, 'Server Error', null);
            }
            return [2 /*return*/];
        });
    });
